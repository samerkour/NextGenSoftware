...
using NextGen.Modules.Catalogs.Categories.Exceptions.Domain;
using NextGen.Modules.Catalogs.Products.Dtos;
using NextGen.Modules.Catalogs.Products.Features.CreatingProduct.Requests;
...
using NextGen.Modules.Catalogs.Suppliers.Exceptions.Application;
using FluentValidation;
using Microsoft.EntityFrameworkCore;

namespace NextGen.Modules.Catalogs.Products.Features.CreatingProduct;
