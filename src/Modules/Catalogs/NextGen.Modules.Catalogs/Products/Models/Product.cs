...
using NextGen.Modules.Catalogs.Products.Exceptions.Domain;
using NextGen.Modules.Catalogs.Products.Features.ChangingMaxThreshold;
using NextGen.Modules.Catalogs.Products.Features.ChangingProductBrand.Events.Domain;
using NextGen.Modules.Catalogs.Products.Features.ChangingProductCategory.Events;
using NextGen.Modules.Catalogs.Products.Features.ChangingProductPrice;
using NextGen.Modules.Catalogs.Products.Features.ChangingProductSupplier.Events;
using NextGen.Modules.Catalogs.Products.Features.ChangingRestockThreshold;
using NextGen.Modules.Catalogs.Products.Features.CreatingProduct.Events.Domain;
using NextGen.Modules.Catalogs.Products.Features.DebitingProductStock.Events.Domain;
using NextGen.Modules.Catalogs.Products.Features.ReplenishingProductStock.Events.Domain;
using NextGen.Modules.Catalogs.Products.ValueObjects;
using NextGen.Modules.Catalogs.Suppliers;

namespace NextGen.Modules.Catalogs.Products.Models;
