...
using NextGen.Modules.Customers.RestockSubscriptions.Exceptions.Domain;
using NextGen.Modules.Customers.RestockSubscriptions.Features.CreatingRestockSubscription.Events.Domain;
using NextGen.Modules.Customers.RestockSubscriptions.Features.DeletingRestockSubscription;
using NextGen.Modules.Customers.RestockSubscriptions.Features.ProcessingRestockNotification;
using NextGen.Modules.Customers.RestockSubscriptions.ValueObjects;

namespace NextGen.Modules.Customers.RestockSubscriptions.Models.Write;
