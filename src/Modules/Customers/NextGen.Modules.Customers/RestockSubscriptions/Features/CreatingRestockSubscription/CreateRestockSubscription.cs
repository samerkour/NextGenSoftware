...
using NextGen.Modules.Customers.Customers.Exceptions.Application;
using NextGen.Modules.Customers.Products.Exceptions;
using NextGen.Modules.Customers.RestockSubscriptions.Dtos;
using NextGen.Modules.Customers.RestockSubscriptions.Features.CreatingRestockSubscription.Exceptions;
...
using NextGen.Modules.Customers.Shared.Clients.Catalogs;
using NextGen.Modules.Customers.Shared.Data;
using NextGen.Modules.Customers.Shared.Extensions;
