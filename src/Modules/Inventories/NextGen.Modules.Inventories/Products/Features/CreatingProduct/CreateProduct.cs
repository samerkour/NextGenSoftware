...
public class CreateProductHandler : ICommandHandler<CreateProduct, CreateProductResponse>
{
    ...
    public CreateProductHandler(
        IInventoryDbContext inventoryDbContext,
        IMapper mapper,
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _inventoryDbContext.Products.AddAsync(product, cancellationToken: cancellationToken);

        await _inventoryDbContext.SaveChangesAsync(cancellationToken);

        var created = await _inventoryDbContext.Products
            .Include(x => x.Brand)
