...
public class GeRestockSubscriptionsHandler : IQueryHandler<GetRestockSubscriptions, GetRestockSubscriptionsResponse>
{
    ...
    public GeRestockSubscriptionsHandler(PartiesReadDbContext partiesReadDbContext, IMapper mapper)
    {
    ...
    {
        var filtering = _partiesReadDbContext.RestockSubscriptions.AsQueryable()
