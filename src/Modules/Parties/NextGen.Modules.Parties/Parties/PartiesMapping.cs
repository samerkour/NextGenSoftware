...
public class PartiesMapping : Profile
{
    ...
    {
        CreateMap<PartyReadModel, PartyReadDto>()
        ...
        CreateMap<Party, CreateMongoPartyReadModels>()
            .ForMember(x => x.Id, opt => opt.Ignore())
            .ForMember(x => x.PartyId, opt => opt.MapFrom(x => x.Id.Value))
        ...
        CreateMap<CreateMongoPartyReadModels, PartyReadModel>()
            .ForMember(x => x.Id, opt => opt.MapFrom(x => x.Id))
            .ForMember(x => x.PartyId, opt => opt.MapFrom(x => x.PartyId));

        CreateMap<Party, UpdateMongoPartyReadsModel>()
            .ForMember(x => x.PartyId, opt => opt.MapFrom(x => x.Id.Value))
            .ForMember(x => x.Id, opt => opt.Ignore())
            .ForMember(x => x.Country, opt => opt.MapFrom(x => x.Address == Address.Null ? "" : x.Address!.City))
            .ForMember(x => x.City, opt => opt.MapFrom(x => x.Address == Address.Null ? "" : x.Address!.City))
        ...
        CreateMap<UpdateMongoPartyReadsModel, PartyReadModel>()
            .ForMember(x => x.Id, opt => opt.MapFrom(x => x.Id))
            .ForMember(x => x.PartyId, opt => opt.MapFrom(x => x.PartyId));
    }
}
