...
internal class SendEmailVerificationCodeHandler : ICommandHandler<SendEmailVerificationCodeCommand>
{
    ...
    public async Task<Unit> Handle(SendEmailVerificationCodeCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            Code = verificationCode, Email = request.Email, SentAt = DateTime.Now
        };
